...
public class Plan {
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator="planID")
	@SequenceGenerator(name="planID", sequenceName="sequence2", initialValue=1, allocationSize=0)
	private int planID;
	...
	public Plan() {}
	public Plan(int planID, PostpaidAccount postPaid, int monthlyRental, int freeLocalCalls, int freeStdCalls,
			int freeLocalSMS, int freeStdSMS, int freeInternetDataUsageUnits, float localCallRate, float stdCallRate,
			float localSMSRate, float stdSMSRate, float internetDataUsageRate, String planCircle, String planName) {
		super();
		this.planID = planID;
